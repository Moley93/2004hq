...
<br>
<br>
Minimum requirements: Level 25 Ranged, Must beat 3 level 91 demons, Must have completed Biohazard Quest, Good thieving and agility is an advantage, level 25 agility is recomended though.<br>
<br>
<br>
Items needed:Items needed: Bow, arrows,spade, rope (maybe 2 if you want to save a tiny bit of time), armour and weapon, food (Note: you might want to take a bow and arrows, that you do not mind dropping. After certain points you will not need them again, and inventory space can get pretty low.)<br>
...
<br>
1. Start, talk to king Lathas who is the second floor of the paladin tower in Ardourgne, he will tell you about the quest and tells you to talk to one of his scouts.<br>
<br>
...
<br>
3. Now, here there are 2 choices. You can either, if you brought 2 ropes, you can use one rope on one of the stalactites, or the agility way of climbing over the rocks I recommend climbing the rockslides.<br>
<br>
4. On the other side of swamp you meet Koftik again, talk to him and you get a damp cloth use it on the arrows you took to get a fire arrow, talk to him again to get another damp cloth and rap it around the other arrows, repeat until you have round about 10 fire arrows. Use these arrows on the fire near by to set them alight.<br>
<br>
<img src="img\questimages\underground1.jpg" height="100" width="100"><br>
<br>
5. Now, go around the cliff to the north and you should be behind a fence, try shooting at the guide ropes that hold the bridge up. When you hit it you are automatically taken across it. positioning is critical when shooting at ropes should be at fence in center of the length of the fence.<br>
<br>
...
<br>
11. When you are across all the traps there should be a well in the middle of the room. This part is quite easy, go up the north road and notice there are flat rocks on the floor, use the plank on the flat rocks to cross until you get to the orb of light, pick it up then return the the well.<br>
<br>
...
<br>
14. This is the easiest path, the south west path, search the flat stone under orb, when you try to pick up the orb of light it will ask you if you want to disarm it. If you fail you damaged by a swinging log. If you succeed return back to the well.<br>
<br>
15. Now either run across the path with the strange markings or search the odd markings and disarm the traps to return to the room with the zombies. Use all the orbs with the furnace and go back across to the room with the well y either disarming the traps or running.<br>
<br>
<img src="img\questimages\underground5.jpg" height="350" width="350"><br>
<br>
16. Climb down the well and search the crates nearby, one will contain some food. Now run across the path to get to some cages, pick lock the cage to the southeast use the spade on the mud to get through a tunnel.<br>
<br>
<img src="img\questimages\underground6.jpg" height="350" width="350"><br>
<br>
17. Head west and cross the ledge to get the another hard part. If you are a level 50+ thief then pick lock the gate and then the other gate or if you are a bad thief, like me then you need to cross the stone bridges to get to the other end.<br>
<br>
...
<br>
19. Search the Unicorn Cage for a railing. Go around to were the boulder is.<br>
<br>
...
<br>
29. Go to the east of this area for Iban's Tomb. Use the dwarf brew with it and set it on fire with a Tinderbox. Take Iban's flesh and smear it on the Doll. *You can now drop your Tinderbox*<br>
<br>
30. Head to the northeast. To where all the spiders are. Kill the HUGE spider for Blood. Smear it on the Doll.<br>
<br>
...
NOTE- when looking for the dove, remember to look in both parts there are two parts with cages one north western (in the corner) and another a little more south from there...<br>
<br>
33. Now for the Final Battle. Head to the middle of the maze, kill some Iban Disciples for Zamorak Robes, wear them, and go inside. Before entering the temple, make sure you have 2 or 3 empty inventory slots .Inorder to enter the temple you cannot have anything in your weapon inventory except for the Robe of Zamorak.If you need food Klank will sell some to you.<br>
<br>
...
<br>
35. Run towards him, hopefully dodging the shots, and throw the Doll into the Well. Iban will die. add stay there it will take a little for blasts to stop after you successfully throw doll in well.<br>
<br>
