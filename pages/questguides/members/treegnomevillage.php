...
<br>
Reward: A gnome amulet of protection, 11,500 Attack XP, the ability to use the spirit trees to travel<br>
<h3>Instructions:</h3>
...
<br>
<input type="checkbox"> Talk to Commander Montai to get the latest update with the battle. He'll ask for 6 loads of wood to repair defenses. Assuming you have your 6 logs with you, talk to him again. He will thank you. Speak to him once more, and he'll ask you to find the coordinates from his trackers to fire the ballista at the Khazard stronghold.<br>
<br>
<input type="checkbox"> Head north to find the first tracker. He's in an oblong building in the northeast part of the Khazard camp. You'll learn that the Y-coordinate is 5.<br>
<br>
<input type="checkbox"> Head west, above the long building. The second gnome should be just along the wall. You'll find that the height coordinate is 4.<br>
<br>
...
<br>
<input type="checkbox"> Run past his guards and attack him. You should have food, which you should run and eat if your health gets low. Ranging and maging work well on him, since he cannot leave a certain zone. Weaken him until you run out or he's fairly weak, then charge him and kill him.<br>
<br>
<input type="checkbox"> Once he is dead (congratulations!), you'll receive the orbs. Return once again to Elkoy, then to Bolren. He'll tell you about the Spirit Trees and give you your reward.<br>
$questComplete
<br>
