...
<br>
After you read the Battered book, use your knife on the book and you will get a Battered key. Do not drop the Battered book, you will need it later to make the Elemental Shield.<br>
<br>
Go to the building north which has a anvil in it and use the key on the Odd Looking Wall. Then go down the stairs.<br>
<br>
<img src="img\questimages\elemental4.png" height="200" width="200"><br>
<br>
A map of the places for some of the next steps:<br>
<br>
<img src="img\questimages\elemental5.png" height="400" width="400"><br>
<br>
When you're in, go down the west path and try and mine a rock. You will be attacked by an level 35 Earth elemental. Kill the Earth elemental and it will drop an Elemental ore, pick it up.<br>
<br>
<img src="img\questimages\elemental6.png" height="200" width="200"><br>
<br>
Now go to the north passage from where you came in, turn the valves so there are like this. First you need to turn the right valve then the left valve to make water wheel move. Then pull the lever. (Right valve is the first and the second is the left valve).<br>
<br>
<img src="img\questimages\elemental7.png" height="200" width="350"><br>
<br>
After that go to the east passage and fix the bellows. This is where the leather, thread and needle comes in.<br>
<br>
...
<br>
After that search all the creates for A stone bowl (you will only need to search each crate once). The location is different for each player. When you find it go down the south passage.<br>
<br>
<img src="img\questimages\elemental9.png" height="200" width="350"><br>
<br>
Use the bowl on the lava and you will get A stone bowl filled with lava. Then use the bowl with lava in it on the furnace.<br>
<br>
<img src="img\questimages\elemental10.gif" height="300" width="200"><br>
<br>
Go back to the bellows and pull the switch.<br>
<br>
Go back to the furnace and use your Elemental ore and 4 coal on the furnace.<br>
<br>
