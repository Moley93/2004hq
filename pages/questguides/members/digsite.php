...
<p><span>Description:</span> Feeling uneducated?
  ...
  <p><span>Items/Skills Needed To Start:</span>
    ...
    a cup of tea at the new tea shop in Varrock), Pestle and Mortar, 2 Rope (can
    pickpocket workmen to get ropes), An Empty Vial, Tinderbox, Gloves, and Boots 
    (Wear gloves and boots at all times!) </p>
  <p><span>Starting Location:</span> All the
    way southeast of Varrock, (just north of Scorpion Pit mine) Go through gate,
    head east into building with red floor and talk to Examiners.</p>
  <p><span>Reward:</span> 2 Quest Points,
    2 Gold Bars, 2,000 Herblaw Experience, 15,300 Mining Experience, and of course the ability to Pan and Dig at
    the Dig Site.<br>
  ...
  <ul>
    ...
    <li><input type="checkbox"> Go to the Varrock Museum. Use the unstamped
      ...
      have them; put them on! Also if you don't already have a cup of tea, on your
      way out of Varrock, buy a cup of tea from the new tea salesman next to the
    ...
    <li><input type="checkbox"> Go southeast from the tent to the stream and use
      ...
      some tea he will look the other way. Use the cup of tea on the guide to
      be allowed to pan. Once you pan the stream you must search the panning tray
      to see what you found. Pan until you get a rock sample covered with mud and
      2 opals if you didn't bring cut opals with you (you may need more than two
    ...
    <li><input type="checkbox"> Talk to a student in a green shirt, just north
      ...
      He will take rock sample 2 and give this answer: the eligible people to use
      the digsite are all that have passed the appropriate earth sciences exam.
      Just a bit north of here, talk to a female student in a purple shirt. She
      will take rock sample 3 and give this answer: the proper health and safety
      points are gloves and boots to be worn at all times, proper tools must be
      used.<br>
      <br>
    </li>
    <li><input type="checkbox"> Go back to the Examiner and take the exam. She
      ...
      a workman for one. You can take the certificate to the Curator at the
      museum for safekeeping or you can hold onto it until you get all three and
    ...
    <li><input type="checkbox"> Go speak to the students again to get the answers
      ...
      in rough form, kept only in sealed containers. The purple shirt student
      explains finds handling: finds must be carefully handled, and gloves worn...
      You will get a certificate for completing the 2nd exam. You can take the
      certificate to the curator at the museum for safekeeping or you can hold
    ...
    <li><input type="checkbox"> Go speak to the students again to get the answers
      ...
      Sample preparation: samples cleaned and carried only in specimen jars. Take her
      answer and the guy's answers and go to the Examiner and take the third exam.
      You will get a certificate for completing the 3rd exam. You now have graduated
      and can dig anywhere in the dig site. Take your certificate to the curator
      in the Varrock museum and you either get a Chocolate Cake or Fruit Blast as a
    ...
    <li><input type="checkbox"> Go to the north east corner to the level 3 area
      ...
      can use his personal mine shaft (which is the winch next to the area you
    ...
    <li><input type="checkbox"> Return to the digsite and use the letter with a
      ...
      reach the bottom. Use the rope with the winch and operate it to lower yourself
    ...
    <li><input type="checkbox"> Go back to the dig site to the northeast winch; the
      ...
      invited to work here, then, do you know where I can find a chest key then
      from then on use the first option in every sentence to beg yourself a new
      key.<br>
      <br>
    </li>
