...
<p>
    ...
    <table class="calculators">
        ...
        <tr>
            <td><canvas data-itemname="logs"></canvas><br>Normal</td>
            <td>1</td>
            <td>40</td>
            <td>No</td>
        </tr>
        <tr>
            <td><canvas data-itemname="achey_logs"></canvas><br>Achey</td>
            <td>1</td>
            <td>40</td>
            <td>No</td>
        </tr>
        <tr>
            <td><canvas data-itemname="oak_logs"></canvas><br>Oak</td>
            <td>15</td>
            <td>60</td>
            <td>No</td>
        </tr>
        <tr>
            <td><canvas data-itemname="willow_logs"></canvas><br>Willow</td>
            <td>30</td>
            <td>90</td>
            <td>No</td>
        </tr>
        <!-- disabled till 2005
        <tr>
            <td><canvas data-itemname="teak_logs"></canvas><br>Teak</td>
            <td>35</td>
            <td>105</td>
            <td>Yes</td>
        </tr>
        -->
        <tr>
            <td><canvas data-itemname="maple_logs"></canvas><br>Maple</td>
            <td>45</td>
            <td>135</td>
            <td>No</td>
        </tr>
        <!-- disabled till 2005
        <tr>
            <td><canvas data-itemname="mahogany_logs"></canvas><br>Mahogany</td>
            <td>50</td>
            <td>157.5</td>
            <td>Yes</td>
        </tr>
        -->
        <tr>
            <td><canvas data-itemname="yew_logs"></canvas><br>Yew</td>
            <td>60</td>
            <td>202.5</td>
            <td>No</td>
        </tr>
        <tr>
            <td><canvas data-itemname="magic_logs"></canvas><br>Magic</td>
            <td>75</td>
            <td>303.8</td>
            <td>Yes</td>
        </tr>
