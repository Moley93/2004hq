<html>
    <head>
        ...
        <meta property="og:url" content="<?php echo $_SERVER['REQUEST_SCHEME'].'://'.$_SERVER['HTTP_HOST'].dirname($_SERVER["REQUEST_URI"]).'/'.$meta_data['og:url']; ?>" />
        <meta property="og:image" content="<?php echo $_SERVER['REQUEST_SCHEME'].'://'.$_SERVER['HTTP_HOST'].dirname($_SERVER["REQUEST_URI"]).'/'.$meta_data['og:image']; ?>" />
        ...
        <style>
            ...
            .whitelink { color: white; text-decoration: none }
              @font-face { font-family: RSBold12; src: url('assets/RuneScape-Bold-12.otf'); } 
              @font-face { font-family: RSPlain12; src: url('assets/RuneScape-Plain-12.otf'); } 
              @font-face { font-family: RSQuill8; src: url('assets/RuneScape-Quill-8.otf'); } 
